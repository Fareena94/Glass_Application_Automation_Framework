...
public class FilePaths {
    ...
    public static final String LOGIN_PAGE_LOCATORS = RESOURCE_FOLDER_PATH + "WebLocators" + File.separator + "RequesterPagesLocators.properties";
    public static final String LOGIN_PAGE_DATA = RESOURCE_FOLDER_PATH + "InputData" + File.separator + "RequesterData.json";
